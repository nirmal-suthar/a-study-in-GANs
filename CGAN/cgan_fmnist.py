...
# #parser.add_argument('--dataset', required=True, help='cifar10 | fmnist | mnist')
...
# preprocessing for mnist, fmnist, cifar10
...
for epoch in range(opt.epoch): 
    ...
    for i, data in enumerate(dataloader):
        ...
        if i%100 == 0: 
            ...
            vutils.save_image(fake.detach(), '%s/images/fake_samples_epoch_%03d.png' % (opt.output, epoch), normalize=True)
